------------------------------------------------------
-- This script will create a sample database "NASD" --
-- in MS SQL Server and will populate its tables.   --
------------------------------------------------------

USE master
GO

CREATE DATABASE NASD
GO
...
CREATE TABLE Town(
  ...
  CONSTRAINT PK_Town PRIMARY KEY CLUSTERED(TownID ASC)
)
GO

SET IDENTITY_INSERT Town ON

INSERT INTO Town (TownID, Name)
VALUES (1, 'Redmond')
...
INSERT INTO Address (AddressID, AddressText, TownID)
...
INSERT INTO Employee (EmployeeID, FirstName, LastName, MiddleName, JobTitle, DepartmentID, ManagerID, HireDate, Salary, AddressID)
...
ADD CONSTRAINT FK_Employee_Address FOREIGN KEY(AddressID)
...
ALTER TABLE Employee
ADD CONSTRAINT FK_Employee_Employee FOREIGN KEY(ManagerID)
REFERENCES Employee(EmployeeID)
GO

ALTER TABLE EmployeeProject
ADD CONSTRAINT FK_EmployeeProject_Employee FOREIGN KEY(EmployeeID)
REFERENCES Employee(EmployeeID)
GO

ALTER TABLE EmployeeProject
ADD CONSTRAINT FK_EmployeeProject_Project FOREIGN KEY(ProjectID)
REFERENCES Project(ProjectID)
GO

ALTER TABLE Department
ADD CONSTRAINT FK_Department_Employee FOREIGN KEY(ManagerID)
REFERENCES Employee(EmployeeID)
GO

ALTER TABLE Address
ADD CONSTRAINT FK_Address_Town FOREIGN KEY(TownID)
